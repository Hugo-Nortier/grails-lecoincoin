...
<html>
    ...
    <body>
        ...
        <div id="show-annonce" class="content scaffold-show" role="main">
            ...
            <ul class="property-list annonce">
                ...
                <li class="fieldcontain">
                    ...
                    <div class="property-value" aria-labelledby="title-label"> ${this.annonce.description}</div>
                </li>
                <li class="fieldcontain">
                ...
                <li class="fieldcontain">
                    ...
                    <g:each var="illustration" in="${this.annonce.illustrations}">
                        <li >
                            <img src="${grailsApplication.config.illustrations.baseUrl+illustration.filename}"/> </li>
                    </g:each>
                </ul>
                    </div>
                </li>
                <li class="fieldcontain">
                    ...
                    <div class="property-value" aria-labelledby="author-label"> <a href="${grailsApplication.config.illustrations.baseUrl}/user/show/${this.annonce.author.getId()}">${this.annonce.author.getUsername()}</a></div>
                </li>
            </ul>
